...
static const char normfgcolor[]     = "#888877";
static const char selbordercolor[]  = "#AB1031";
...
/* tagging */
static const char *tags[] = { "comm", "web", "a", "b", "c", "etc" };
...
static const char *termcmd[]  = { "urxvt",  "-name", "coding", NULL };
